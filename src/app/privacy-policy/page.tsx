  ...
  return (
    <div className="bg-black text-white">
      <div className="max-w-3xl mx-auto py-12 px-6">
        ...
        <p className="mb-4">
          Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info/" className="text-blue-500 underline">Privacy Policy Generator</a>.
        </p>
