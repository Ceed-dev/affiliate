    ...
    <div className="flex flex-row items-center gap-3 md:gap-6">
      {number > 1 && 
        <div className="flex-shrink-0">
          <Image src="/assets/common/right-arrow.png" height={20} width={20} alt="right-arrow.png" />
        </div>
      }
      {number < currentStep 
        ? <div className="w-[40px] h-[40px] min-w-[40px] min-h-[40px] bg-blue-500 rounded-full flex justify-center items-center animate-checkmarkAppear flex-shrink-0">
            <Image src="/assets/common/checkmark.png" width={15} height={15} alt="checkmark.png" />
          </div>
